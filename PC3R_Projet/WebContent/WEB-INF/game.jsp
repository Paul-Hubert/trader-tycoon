		...
		<div class="row m-top">
			...
			<div class="col">
				<form>
					...
					<div class="form-group">
						<select class="custom-select mb-2" name="ressource" required>
			     	...
			     	<div class="form-check">
					  <input class="form-check-input" type="checkbox" name="auto-price" value="true">
			     	...
			     	<div class="form-group form-check-inline">
				  	...
				  	<div class="form-check">
					  <input class="form-check-input" type="checkbox" name="auto-quantity" value="true">
